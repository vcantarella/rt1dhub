...
if (NOT TARGET Qt5::Help)
    ...
    _populate_Help_target_properties(RELEASE "Qt5Help_conda.dll" "Qt5Help_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Help_install_prefix}/bin/Qt5Help_condad.dll"
      AND EXISTS
        "${_qt5Help_install_prefix}/lib/Qt5Help_condad.lib" )
        _populate_Help_target_properties(DEBUG "Qt5Help_condad.dll" "Qt5Help_condad.lib" FALSE)
    endif()
