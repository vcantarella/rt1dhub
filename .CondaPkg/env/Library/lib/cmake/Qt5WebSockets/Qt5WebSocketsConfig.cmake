...
set(Qt5WebSockets_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::WebSockets)
    ...
    set(_Qt5WebSockets_OWN_INCLUDE_DIRS "${_qt5WebSockets_install_prefix}/include/qt/" "${_qt5WebSockets_install_prefix}/include/qt/QtWebSockets")
    set(Qt5WebSockets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebSockets_install_prefix}/include/qt/QtWebSockets/5.15.8"
        "${_qt5WebSockets_install_prefix}/include/qt/QtWebSockets/5.15.8/QtWebSockets"
    )
    ...
    foreach(_module_dep ${_Qt5WebSockets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5WebSockets_FIND_VERSION_EXACT}
    ...
    _populate_WebSockets_target_properties(RELEASE "Qt5WebSockets_conda.dll" "Qt5WebSockets_conda.lib" FALSE)

    if (EXISTS
        "${_qt5WebSockets_install_prefix}/bin/Qt5WebSockets_condad.dll"
      AND EXISTS
        "${_qt5WebSockets_install_prefix}/lib/Qt5WebSockets_condad.lib" )
        _populate_WebSockets_target_properties(DEBUG "Qt5WebSockets_condad.dll" "Qt5WebSockets_condad.lib" FALSE)
    endif()
