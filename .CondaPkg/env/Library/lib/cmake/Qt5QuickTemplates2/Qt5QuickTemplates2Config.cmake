...
set(Qt5QuickTemplates2_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::QuickTemplates2)
    ...
    set(_Qt5QuickTemplates2_OWN_INCLUDE_DIRS "${_qt5QuickTemplates2_install_prefix}/include/qt/" "${_qt5QuickTemplates2_install_prefix}/include/qt/QtQuickTemplates2")
    set(Qt5QuickTemplates2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTemplates2_install_prefix}/include/qt/QtQuickTemplates2/5.15.8"
        "${_qt5QuickTemplates2_install_prefix}/include/qt/QtQuickTemplates2/5.15.8/QtQuickTemplates2"
    )
    ...
    foreach(_module_dep ${_Qt5QuickTemplates2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5QuickTemplates2_FIND_VERSION_EXACT}
    ...
    _populate_QuickTemplates2_target_properties(RELEASE "Qt5QuickTemplates2_conda.dll" "Qt5QuickTemplates2_conda.lib" FALSE)

    if (EXISTS
        "${_qt5QuickTemplates2_install_prefix}/bin/Qt5QuickTemplates2_condad.dll"
      AND EXISTS
        "${_qt5QuickTemplates2_install_prefix}/lib/Qt5QuickTemplates2_condad.lib" )
        _populate_QuickTemplates2_target_properties(DEBUG "Qt5QuickTemplates2_condad.dll" "Qt5QuickTemplates2_condad.lib" FALSE)
    endif()
