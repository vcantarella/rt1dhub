...
if (NOT TARGET Qt5::3DQuickExtras)
    ...
    _populate_3DQuickExtras_target_properties(RELEASE "Qt53DQuickExtras_conda.dll" "Qt53DQuickExtras_conda.lib" FALSE)

    if (EXISTS
        "${_qt53DQuickExtras_install_prefix}/bin/Qt53DQuickExtras_condad.dll"
      AND EXISTS
        "${_qt53DQuickExtras_install_prefix}/lib/Qt53DQuickExtras_condad.lib" )
        _populate_3DQuickExtras_target_properties(DEBUG "Qt53DQuickExtras_condad.dll" "Qt53DQuickExtras_condad.lib" FALSE)
    endif()
