...
set(Qt5TextToSpeech_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::TextToSpeech)
    ...
    set(_Qt5TextToSpeech_OWN_INCLUDE_DIRS "${_qt5TextToSpeech_install_prefix}/include/qt/" "${_qt5TextToSpeech_install_prefix}/include/qt/QtTextToSpeech")
    set(Qt5TextToSpeech_PRIVATE_INCLUDE_DIRS
        "${_qt5TextToSpeech_install_prefix}/include/qt/QtTextToSpeech/5.15.8"
        "${_qt5TextToSpeech_install_prefix}/include/qt/QtTextToSpeech/5.15.8/QtTextToSpeech"
    )
    ...
    foreach(_module_dep ${_Qt5TextToSpeech_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5TextToSpeech_FIND_VERSION_EXACT}
    ...
    _populate_TextToSpeech_target_properties(RELEASE "Qt5TextToSpeech_conda.dll" "Qt5TextToSpeech_conda.lib" FALSE)

    if (EXISTS
        "${_qt5TextToSpeech_install_prefix}/bin/Qt5TextToSpeech_condad.dll"
      AND EXISTS
        "${_qt5TextToSpeech_install_prefix}/lib/Qt5TextToSpeech_condad.lib" )
        _populate_TextToSpeech_target_properties(DEBUG "Qt5TextToSpeech_condad.dll" "Qt5TextToSpeech_condad.lib" FALSE)
    endif()
