...
if (NOT TARGET Qt5::Sql)
    ...
    _populate_Sql_target_properties(RELEASE "Qt5Sql_conda.dll" "Qt5Sql_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Sql_install_prefix}/bin/Qt5Sql_condad.dll"
      AND EXISTS
        "${_qt5Sql_install_prefix}/lib/Qt5Sql_condad.lib" )
        _populate_Sql_target_properties(DEBUG "Qt5Sql_condad.dll" "Qt5Sql_condad.lib" FALSE)
    endif()
