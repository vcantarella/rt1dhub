...
if (NOT TARGET Qt5::3DLogic)
    ...
    _populate_3DLogic_target_properties(RELEASE "Qt53DLogic_conda.dll" "Qt53DLogic_conda.lib" FALSE)

    if (EXISTS
        "${_qt53DLogic_install_prefix}/bin/Qt53DLogic_condad.dll"
      AND EXISTS
        "${_qt53DLogic_install_prefix}/lib/Qt53DLogic_condad.lib" )
        _populate_3DLogic_target_properties(DEBUG "Qt53DLogic_condad.dll" "Qt53DLogic_condad.lib" FALSE)
    endif()
