...
set(Qt5Test_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::Test)
    ...
    set(Qt5Test_PRIVATE_INCLUDE_DIRS
        "${_qt5Test_install_prefix}/include/qt/QtTest/5.15.8"
        "${_qt5Test_install_prefix}/include/qt/QtTest/5.15.8/QtTest"
    )
    ...
    foreach(_module_dep ${_Qt5Test_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5Test_FIND_VERSION_EXACT}
    ...
    _populate_Test_target_properties(RELEASE "Qt5Test_conda.dll" "Qt5Test_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Test_install_prefix}/bin/Qt5Test_condad.dll"
      AND EXISTS
        "${_qt5Test_install_prefix}/lib/Qt5Test_condad.lib" )
        _populate_Test_target_properties(DEBUG "Qt5Test_condad.dll" "Qt5Test_condad.lib" FALSE)
    endif()
