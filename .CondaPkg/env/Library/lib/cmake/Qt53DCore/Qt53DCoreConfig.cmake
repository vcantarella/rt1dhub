...
set(Qt53DCore_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::3DCore)
    ...
    set(Qt53DCore_PRIVATE_INCLUDE_DIRS
        "${_qt53DCore_install_prefix}/include/qt/Qt3DCore/5.15.8"
        "${_qt53DCore_install_prefix}/include/qt/Qt3DCore/5.15.8/Qt3DCore"
    )
    ...
    foreach(_module_dep ${_Qt53DCore_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt53DCore_FIND_VERSION_EXACT}
    ...
    _populate_3DCore_target_properties(RELEASE "Qt53DCore_conda.dll" "Qt53DCore_conda.lib" FALSE)

    if (EXISTS
        "${_qt53DCore_install_prefix}/bin/Qt53DCore_condad.dll"
      AND EXISTS
        "${_qt53DCore_install_prefix}/lib/Qt53DCore_condad.lib" )
        _populate_3DCore_target_properties(DEBUG "Qt53DCore_condad.dll" "Qt53DCore_condad.lib" FALSE)
    endif()
