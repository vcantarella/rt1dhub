...
set(Qt5PositioningQuick_VERSION_STRING 5.15.8)
...
macro(_populate_PositioningQuick_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5PositioningQuick_install_prefix}/bin/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5PositioningQuick_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_PositioningQuick_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::PositioningQuick)
    ...
    set(_Qt5PositioningQuick_OWN_INCLUDE_DIRS "${_qt5PositioningQuick_install_prefix}/include/qt/" "${_qt5PositioningQuick_install_prefix}/include/qt/QtPositioningQuick")
    set(Qt5PositioningQuick_PRIVATE_INCLUDE_DIRS
        "${_qt5PositioningQuick_install_prefix}/include/qt/QtPositioningQuick/5.15.8"
        "${_qt5PositioningQuick_install_prefix}/include/qt/QtPositioningQuick/5.15.8/QtPositioningQuick"
    )
    ...
    # specified.
    list(FIND Qt5PositioningQuick_FIND_COMPONENTS Private _check_private)
    if (NOT _check_private STREQUAL -1)
        foreach(_dir ${Qt5PositioningQuick_PRIVATE_INCLUDE_DIRS})
            _qt5_PositioningQuick_check_file_exists(${_dir})
        endforeach()
    endif()
    ...
    set(_Qt5PositioningQuick_MODULE_DEPENDENCIES "Quick;Qml;Positioning;Core")
    ...
    foreach(_module_dep ${_Qt5PositioningQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5PositioningQuick_FIND_VERSION_EXACT}
    ...
    set(_Qt5PositioningQuick_LIB_DEPENDENCIES "Qt5::Quick;Qt5::Qml;Qt5::Positioning;Qt5::Core")
    ...
    _populate_PositioningQuick_target_properties(RELEASE "Qt5PositioningQuick_conda.dll" "Qt5PositioningQuick_conda.lib" FALSE)

    if (EXISTS
        "${_qt5PositioningQuick_install_prefix}/bin/Qt5PositioningQuick_condad.dll"
      AND EXISTS
        "${_qt5PositioningQuick_install_prefix}/lib/Qt5PositioningQuick_condad.lib" )
        _populate_PositioningQuick_target_properties(DEBUG "Qt5PositioningQuick_condad.dll" "Qt5PositioningQuick_condad.lib" FALSE)
    endif()
