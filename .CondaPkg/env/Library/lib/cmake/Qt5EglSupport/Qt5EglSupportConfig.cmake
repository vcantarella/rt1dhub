...
set(Qt5EglSupport_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::EglSupport)
    ...
    set(_Qt5EglSupport_OWN_INCLUDE_DIRS "${_qt5EglSupport_install_prefix}/include/qt/" "${_qt5EglSupport_install_prefix}/include/qt/QtEglSupport")
    set(Qt5EglSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5EglSupport_install_prefix}/include/qt/QtEglSupport/5.15.8"
        "${_qt5EglSupport_install_prefix}/include/qt/QtEglSupport/5.15.8/QtEglSupport"
    )
    ...
    foreach(_module_dep ${_Qt5EglSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5EglSupport_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_EglSupport_process_prl_file(
            "${_qt5EglSupport_install_prefix}/lib/Qt5EglSupport_conda.prl" RELEASE
    ...
    _populate_EglSupport_target_properties(RELEASE "Qt5EglSupport_conda.lib" "" FALSE)

    if (EXISTS "${_qt5EglSupport_install_prefix}/lib/Qt5EglSupport_condad.lib" )
        _populate_EglSupport_target_properties(DEBUG "Qt5EglSupport_condad.lib" "" FALSE)
    endif()
