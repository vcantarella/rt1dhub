...
if (NOT TARGET Qt5::3DQuickRender)
    ...
    _populate_3DQuickRender_target_properties(RELEASE "Qt53DQuickRender_conda.dll" "Qt53DQuickRender_conda.lib" FALSE)

    if (EXISTS
        "${_qt53DQuickRender_install_prefix}/bin/Qt53DQuickRender_condad.dll"
      AND EXISTS
        "${_qt53DQuickRender_install_prefix}/lib/Qt53DQuickRender_condad.lib" )
        _populate_3DQuickRender_target_properties(DEBUG "Qt53DQuickRender_condad.dll" "Qt53DQuickRender_condad.lib" FALSE)
    endif()
