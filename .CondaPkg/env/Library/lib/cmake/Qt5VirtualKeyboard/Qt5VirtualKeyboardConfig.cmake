...
set(Qt5VirtualKeyboard_VERSION_STRING 5.15.8)
...
macro(_populate_VirtualKeyboard_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5VirtualKeyboard_install_prefix}/bin/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::VirtualKeyboard)
    ...
    set(_Qt5VirtualKeyboard_OWN_INCLUDE_DIRS "${_qt5VirtualKeyboard_install_prefix}/include/qt/" "${_qt5VirtualKeyboard_install_prefix}/include/qt/QtVirtualKeyboard")
    set(Qt5VirtualKeyboard_PRIVATE_INCLUDE_DIRS
        "${_qt5VirtualKeyboard_install_prefix}/include/qt/QtVirtualKeyboard/5.15.8"
        "${_qt5VirtualKeyboard_install_prefix}/include/qt/QtVirtualKeyboard/5.15.8/QtVirtualKeyboard"
    )
    ...
    foreach(_module_dep ${_Qt5VirtualKeyboard_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5VirtualKeyboard_FIND_VERSION_EXACT}
    ...
    _populate_VirtualKeyboard_target_properties(RELEASE "Qt5VirtualKeyboard_conda.dll" "Qt5VirtualKeyboard_conda.lib" FALSE)

    if (EXISTS
        "${_qt5VirtualKeyboard_install_prefix}/bin/Qt5VirtualKeyboard_condad.dll"
      AND EXISTS
        "${_qt5VirtualKeyboard_install_prefix}/lib/Qt5VirtualKeyboard_condad.lib" )
        _populate_VirtualKeyboard_target_properties(DEBUG "Qt5VirtualKeyboard_condad.dll" "Qt5VirtualKeyboard_condad.lib" FALSE)
    endif()
