...
set(Qt5WinExtras_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::WinExtras)
    ...
    set(_Qt5WinExtras_OWN_INCLUDE_DIRS "${_qt5WinExtras_install_prefix}/include/qt/" "${_qt5WinExtras_install_prefix}/include/qt/QtWinExtras")
    set(Qt5WinExtras_PRIVATE_INCLUDE_DIRS
        "${_qt5WinExtras_install_prefix}/include/qt/QtWinExtras/5.15.8"
        "${_qt5WinExtras_install_prefix}/include/qt/QtWinExtras/5.15.8/QtWinExtras"
    )
    ...
    foreach(_module_dep ${_Qt5WinExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5WinExtras_FIND_VERSION_EXACT}
    ...
    _populate_WinExtras_target_properties(RELEASE "Qt5WinExtras_conda.dll" "Qt5WinExtras_conda.lib" FALSE)

    if (EXISTS
        "${_qt5WinExtras_install_prefix}/bin/Qt5WinExtras_condad.dll"
      AND EXISTS
        "${_qt5WinExtras_install_prefix}/lib/Qt5WinExtras_condad.lib" )
        _populate_WinExtras_target_properties(DEBUG "Qt5WinExtras_condad.dll" "Qt5WinExtras_condad.lib" FALSE)
    endif()
...
# Add a versionless target, for compatibility with Qt6.
if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND TARGET Qt5::WinExtras AND NOT TARGET Qt::WinExtras)
