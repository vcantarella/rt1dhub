...
set(Qt53DQuickAnimation_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::3DQuickAnimation)
    ...
    set(_Qt53DQuickAnimation_OWN_INCLUDE_DIRS "${_qt53DQuickAnimation_install_prefix}/include/qt/" "${_qt53DQuickAnimation_install_prefix}/include/qt/Qt3DQuickAnimation")
    set(Qt53DQuickAnimation_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickAnimation_install_prefix}/include/qt/Qt3DQuickAnimation/5.15.8"
        "${_qt53DQuickAnimation_install_prefix}/include/qt/Qt3DQuickAnimation/5.15.8/Qt3DQuickAnimation"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickAnimation_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt53DQuickAnimation_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::3DQuickAnimation
    ...
    if (_Qt53DQuickAnimation_PRIVATE_DIRS_EXIST)
        ...
        if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::3DQuickAnimationPrivate)
            add_library(Qt::3DQuickAnimationPrivate INTERFACE IMPORTED)
            set_target_properties(Qt::3DQuickAnimationPrivate PROPERTIES
                INTERFACE_LINK_LIBRARIES "Qt5::3DQuickAnimationPrivate"
            )
        endif()
    endif()

    _populate_3DQuickAnimation_target_properties(RELEASE "Qt53DQuickAnimation_conda.dll" "Qt53DQuickAnimation_conda.lib" FALSE)

    if (EXISTS
        "${_qt53DQuickAnimation_install_prefix}/bin/Qt53DQuickAnimation_condad.dll"
      AND EXISTS
        "${_qt53DQuickAnimation_install_prefix}/lib/Qt53DQuickAnimation_condad.lib" )
        _populate_3DQuickAnimation_target_properties(DEBUG "Qt53DQuickAnimation_condad.dll" "Qt53DQuickAnimation_condad.lib" FALSE)
    endif()
    ...
    if (QT5_STRICT_PLUGIN_GLOB OR Qt53DQuickAnimation_STRICT_PLUGIN_GLOB)
        file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt53DQuickAnimation_*Plugin.cmake")
    else()
        file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt53DQuickAnimation_*.cmake")
    endif()
...
# Add a versionless target, for compatibility with Qt6.
if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND TARGET Qt5::3DQuickAnimation AND NOT TARGET Qt::3DQuickAnimation)
    add_library(Qt::3DQuickAnimation INTERFACE IMPORTED)
    set_target_properties(Qt::3DQuickAnimation PROPERTIES
        INTERFACE_LINK_LIBRARIES "Qt5::3DQuickAnimation"
    )
endif()
