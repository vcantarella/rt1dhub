...
set(Qt5Purchasing_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::Purchasing)
    ...
    set(_Qt5Purchasing_OWN_INCLUDE_DIRS "${_qt5Purchasing_install_prefix}/include/qt/" "${_qt5Purchasing_install_prefix}/include/qt/QtPurchasing")
    set(Qt5Purchasing_PRIVATE_INCLUDE_DIRS
        "${_qt5Purchasing_install_prefix}/include/qt/QtPurchasing/5.15.8"
        "${_qt5Purchasing_install_prefix}/include/qt/QtPurchasing/5.15.8/QtPurchasing"
    )
    ...
    foreach(_module_dep ${_Qt5Purchasing_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5Purchasing_FIND_VERSION_EXACT}
    ...
    _populate_Purchasing_target_properties(RELEASE "Qt5Purchasing_conda.dll" "Qt5Purchasing_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Purchasing_install_prefix}/bin/Qt5Purchasing_condad.dll"
      AND EXISTS
        "${_qt5Purchasing_install_prefix}/lib/Qt5Purchasing_condad.lib" )
        _populate_Purchasing_target_properties(DEBUG "Qt5Purchasing_condad.dll" "Qt5Purchasing_condad.lib" FALSE)
    endif()
