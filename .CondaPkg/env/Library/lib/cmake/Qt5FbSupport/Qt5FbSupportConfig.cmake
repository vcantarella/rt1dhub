...
set(Qt5FbSupport_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::FbSupport)
    ...
    set(_Qt5FbSupport_OWN_INCLUDE_DIRS "${_qt5FbSupport_install_prefix}/include/qt/" "${_qt5FbSupport_install_prefix}/include/qt/QtFbSupport")
    set(Qt5FbSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5FbSupport_install_prefix}/include/qt/QtFbSupport/5.15.8"
        "${_qt5FbSupport_install_prefix}/include/qt/QtFbSupport/5.15.8/QtFbSupport"
    )
    ...
    foreach(_module_dep ${_Qt5FbSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5FbSupport_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_FbSupport_process_prl_file(
            "${_qt5FbSupport_install_prefix}/lib/Qt5FbSupport_conda.prl" RELEASE
    ...
    _populate_FbSupport_target_properties(RELEASE "Qt5FbSupport_conda.lib" "" FALSE)

    if (EXISTS "${_qt5FbSupport_install_prefix}/lib/Qt5FbSupport_condad.lib" )
        _populate_FbSupport_target_properties(DEBUG "Qt5FbSupport_condad.lib" "" FALSE)
    endif()
