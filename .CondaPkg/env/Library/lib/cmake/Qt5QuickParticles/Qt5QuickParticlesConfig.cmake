...
if (NOT TARGET Qt5::QuickParticles)
    ...
    _populate_QuickParticles_target_properties(RELEASE "Qt5QuickParticles_conda.dll" "Qt5QuickParticles_conda.lib" FALSE)

    if (EXISTS
        "${_qt5QuickParticles_install_prefix}/bin/Qt5QuickParticles_condad.dll"
      AND EXISTS
        "${_qt5QuickParticles_install_prefix}/lib/Qt5QuickParticles_condad.lib" )
        _populate_QuickParticles_target_properties(DEBUG "Qt5QuickParticles_condad.dll" "Qt5QuickParticles_condad.lib" FALSE)
    endif()
