...
set(Qt5PlatformCompositorSupport_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::PlatformCompositorSupport)
    ...
    set(_Qt5PlatformCompositorSupport_OWN_INCLUDE_DIRS "${_qt5PlatformCompositorSupport_install_prefix}/include/qt/" "${_qt5PlatformCompositorSupport_install_prefix}/include/qt/QtPlatformCompositorSupport")
    set(Qt5PlatformCompositorSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PlatformCompositorSupport_install_prefix}/include/qt/QtPlatformCompositorSupport/5.15.8"
        "${_qt5PlatformCompositorSupport_install_prefix}/include/qt/QtPlatformCompositorSupport/5.15.8/QtPlatformCompositorSupport"
    )
    ...
    foreach(_module_dep ${_Qt5PlatformCompositorSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5PlatformCompositorSupport_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_PlatformCompositorSupport_process_prl_file(
            "${_qt5PlatformCompositorSupport_install_prefix}/lib/Qt5PlatformCompositorSupport_conda.prl" RELEASE
    ...
    set_property(TARGET Qt5::PlatformCompositorSupport
    ...
    if (_Qt5PlatformCompositorSupport_PRIVATE_DIRS_EXIST)
        ...
        if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::PlatformCompositorSupportPrivate)
            add_library(Qt::PlatformCompositorSupportPrivate INTERFACE IMPORTED)
            set_target_properties(Qt::PlatformCompositorSupportPrivate PROPERTIES
                INTERFACE_LINK_LIBRARIES "Qt5::PlatformCompositorSupportPrivate"
            )
        endif()
    endif()

    _populate_PlatformCompositorSupport_target_properties(RELEASE "Qt5PlatformCompositorSupport_conda.lib" "" FALSE)

    if (EXISTS "${_qt5PlatformCompositorSupport_install_prefix}/lib/Qt5PlatformCompositorSupport_condad.lib" )
        _populate_PlatformCompositorSupport_target_properties(DEBUG "Qt5PlatformCompositorSupport_condad.lib" "" FALSE)
    endif()
...
# Add a versionless target, for compatibility with Qt6.
if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND TARGET Qt5::PlatformCompositorSupport AND NOT TARGET Qt::PlatformCompositorSupport)
    add_library(Qt::PlatformCompositorSupport INTERFACE IMPORTED)
    set_target_properties(Qt::PlatformCompositorSupport PROPERTIES
        INTERFACE_LINK_LIBRARIES "Qt5::PlatformCompositorSupport"
    )
endif()
