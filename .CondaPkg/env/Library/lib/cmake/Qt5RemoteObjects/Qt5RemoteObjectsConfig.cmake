...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    _populate_RemoteObjects_target_properties(RELEASE "Qt5RemoteObjects_conda.dll" "Qt5RemoteObjects_conda.lib" FALSE)

    if (EXISTS
        "${_qt5RemoteObjects_install_prefix}/bin/Qt5RemoteObjects_condad.dll"
      AND EXISTS
        "${_qt5RemoteObjects_install_prefix}/lib/Qt5RemoteObjects_condad.lib" )
        _populate_RemoteObjects_target_properties(DEBUG "Qt5RemoteObjects_condad.dll" "Qt5RemoteObjects_condad.lib" FALSE)
    endif()
