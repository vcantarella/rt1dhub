...
if (NOT TARGET Qt5::QuickTest)
    ...
    _populate_QuickTest_target_properties(RELEASE "Qt5QuickTest_conda.dll" "Qt5QuickTest_conda.lib" FALSE)

    if (EXISTS
        "${_qt5QuickTest_install_prefix}/bin/Qt5QuickTest_condad.dll"
      AND EXISTS
        "${_qt5QuickTest_install_prefix}/lib/Qt5QuickTest_condad.lib" )
        _populate_QuickTest_target_properties(DEBUG "Qt5QuickTest_condad.dll" "Qt5QuickTest_condad.lib" FALSE)
    endif()
