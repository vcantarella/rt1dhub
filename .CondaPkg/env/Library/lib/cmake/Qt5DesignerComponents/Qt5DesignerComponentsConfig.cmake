...
set(Qt5DesignerComponents_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::DesignerComponents)
    ...
    set(_Qt5DesignerComponents_OWN_INCLUDE_DIRS "${_qt5DesignerComponents_install_prefix}/include/qt/" "${_qt5DesignerComponents_install_prefix}/include/qt/QtDesignerComponents")
    set(Qt5DesignerComponents_PRIVATE_INCLUDE_DIRS
        "${_qt5DesignerComponents_install_prefix}/include/qt/QtDesignerComponents/5.15.8"
        "${_qt5DesignerComponents_install_prefix}/include/qt/QtDesignerComponents/5.15.8/QtDesignerComponents"
    )
    ...
    foreach(_module_dep ${_Qt5DesignerComponents_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5DesignerComponents_FIND_VERSION_EXACT}
    ...
    _populate_DesignerComponents_target_properties(RELEASE "Qt5DesignerComponents_conda.dll" "Qt5DesignerComponents_conda.lib" FALSE)

    if (EXISTS
        "${_qt5DesignerComponents_install_prefix}/bin/Qt5DesignerComponents_condad.dll"
      AND EXISTS
        "${_qt5DesignerComponents_install_prefix}/lib/Qt5DesignerComponents_condad.lib" )
        _populate_DesignerComponents_target_properties(DEBUG "Qt5DesignerComponents_condad.dll" "Qt5DesignerComponents_condad.lib" FALSE)
    endif()
