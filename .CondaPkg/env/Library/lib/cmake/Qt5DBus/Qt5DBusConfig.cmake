...
if (NOT TARGET Qt5::DBus)
    ...
    _populate_DBus_target_properties(RELEASE "Qt5DBus_conda.dll" "Qt5DBus_conda.lib" FALSE)

    if (EXISTS
        "${_qt5DBus_install_prefix}/bin/Qt5DBus_condad.dll"
      AND EXISTS
        "${_qt5DBus_install_prefix}/lib/Qt5DBus_condad.lib" )
        _populate_DBus_target_properties(DEBUG "Qt5DBus_condad.dll" "Qt5DBus_condad.lib" FALSE)
    endif()
