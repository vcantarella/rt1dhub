...
if (NOT TARGET Qt5::Multimedia)
    ...
    _populate_Multimedia_target_properties(RELEASE "Qt5Multimedia_conda.dll" "Qt5Multimedia_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Multimedia_install_prefix}/bin/Qt5Multimedia_condad.dll"
      AND EXISTS
        "${_qt5Multimedia_install_prefix}/lib/Qt5Multimedia_condad.lib" )
        _populate_Multimedia_target_properties(DEBUG "Qt5Multimedia_condad.dll" "Qt5Multimedia_condad.lib" FALSE)
    endif()
