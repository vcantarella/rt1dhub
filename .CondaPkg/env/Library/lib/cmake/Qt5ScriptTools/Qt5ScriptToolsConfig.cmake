...
if (NOT TARGET Qt5::ScriptTools)
    ...
    _populate_ScriptTools_target_properties(RELEASE "Qt5ScriptTools_conda.dll" "Qt5ScriptTools_conda.lib" FALSE)

    if (EXISTS
        "${_qt5ScriptTools_install_prefix}/bin/Qt5ScriptTools_condad.dll"
      AND EXISTS
        "${_qt5ScriptTools_install_prefix}/lib/Qt5ScriptTools_condad.lib" )
        _populate_ScriptTools_target_properties(DEBUG "Qt5ScriptTools_condad.dll" "Qt5ScriptTools_condad.lib" FALSE)
    endif()
