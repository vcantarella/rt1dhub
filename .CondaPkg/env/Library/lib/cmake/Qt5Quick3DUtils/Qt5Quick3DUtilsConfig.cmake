...
macro(_populate_Quick3DUtils_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Quick3DUtils_install_prefix}/bin/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5Quick3DUtils_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_Quick3DUtils_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::Quick3DUtils)
    ...
    _populate_Quick3DUtils_target_properties(RELEASE "Qt5Quick3DUtils_conda.dll" "Qt5Quick3DUtils_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Quick3DUtils_install_prefix}/bin/Qt5Quick3DUtils_condad.dll"
      AND EXISTS
        "${_qt5Quick3DUtils_install_prefix}/lib/Qt5Quick3DUtils_condad.lib" )
        _populate_Quick3DUtils_target_properties(DEBUG "Qt5Quick3DUtils_condad.dll" "Qt5Quick3DUtils_condad.lib" FALSE)
    endif()
