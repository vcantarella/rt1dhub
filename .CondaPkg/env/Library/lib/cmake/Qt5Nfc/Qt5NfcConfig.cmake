...
if (NOT TARGET Qt5::Nfc)
    ...
    _populate_Nfc_target_properties(RELEASE "Qt5Nfc_conda.dll" "Qt5Nfc_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Nfc_install_prefix}/bin/Qt5Nfc_condad.dll"
      AND EXISTS
        "${_qt5Nfc_install_prefix}/lib/Qt5Nfc_condad.lib" )
        _populate_Nfc_target_properties(DEBUG "Qt5Nfc_condad.dll" "Qt5Nfc_condad.lib" FALSE)
    endif()
