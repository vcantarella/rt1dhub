...
if (NOT TARGET Qt5::Location)
    ...
    set_property(TARGET Qt5::Location
                 ...
                 geoservices_esri;geoservices_here;geoservices_itemsoverlay;geoservices_mapbox;geoservices_osm)
    set_property(TARGET Qt5::Location
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 geoservices_mapboxgl;location-labs-plugin)
    ...
    _populate_Location_target_properties(RELEASE "Qt5Location_conda.dll" "Qt5Location_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Location_install_prefix}/bin/Qt5Location_condad.dll"
      AND EXISTS
        "${_qt5Location_install_prefix}/lib/Qt5Location_condad.lib" )
        _populate_Location_target_properties(DEBUG "Qt5Location_condad.dll" "Qt5Location_condad.lib" FALSE)
    endif()
