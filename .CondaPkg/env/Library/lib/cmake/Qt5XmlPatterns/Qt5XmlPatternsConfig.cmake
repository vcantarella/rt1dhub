...
set(Qt5XmlPatterns_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::XmlPatterns)
    ...
    set(_Qt5XmlPatterns_OWN_INCLUDE_DIRS "${_qt5XmlPatterns_install_prefix}/include/qt/" "${_qt5XmlPatterns_install_prefix}/include/qt/QtXmlPatterns")
    set(Qt5XmlPatterns_PRIVATE_INCLUDE_DIRS
        "${_qt5XmlPatterns_install_prefix}/include/qt/QtXmlPatterns/5.15.8"
        "${_qt5XmlPatterns_install_prefix}/include/qt/QtXmlPatterns/5.15.8/QtXmlPatterns"
    )
    ...
    foreach(_module_dep ${_Qt5XmlPatterns_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5XmlPatterns_FIND_VERSION_EXACT}
    ...
    _populate_XmlPatterns_target_properties(RELEASE "Qt5XmlPatterns_conda.dll" "Qt5XmlPatterns_conda.lib" FALSE)

    if (EXISTS
        "${_qt5XmlPatterns_install_prefix}/bin/Qt5XmlPatterns_condad.dll"
      AND EXISTS
        "${_qt5XmlPatterns_install_prefix}/lib/Qt5XmlPatterns_condad.lib" )
        _populate_XmlPatterns_target_properties(DEBUG "Qt5XmlPatterns_condad.dll" "Qt5XmlPatterns_condad.lib" FALSE)
    endif()
