...
if (NOT TARGET Qt5::Network)
    ...
    set_property(TARGET Qt5::Network
                 ...
                 openssl-linked;openssl;netlistmgr;system-proxies)
    set_property(TARGET Qt5::Network
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 libproxy;linux-netlink)
    ...
    _populate_Network_target_properties(RELEASE "Qt5Network_conda.dll" "Qt5Network_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Network_install_prefix}/bin/Qt5Network_condad.dll"
      AND EXISTS
        "${_qt5Network_install_prefix}/lib/Qt5Network_condad.lib" )
        _populate_Network_target_properties(DEBUG "Qt5Network_condad.dll" "Qt5Network_condad.lib" FALSE)
    endif()
