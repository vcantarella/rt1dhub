...
if (NOT TARGET Qt5::Quick)
    ...
    _populate_Quick_target_properties(RELEASE "Qt5Quick_conda.dll" "Qt5Quick_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Quick_install_prefix}/bin/Qt5Quick_condad.dll"
      AND EXISTS
        "${_qt5Quick_install_prefix}/lib/Qt5Quick_condad.lib" )
        _populate_Quick_target_properties(DEBUG "Qt5Quick_condad.dll" "Qt5Quick_condad.lib" FALSE)
    endif()
