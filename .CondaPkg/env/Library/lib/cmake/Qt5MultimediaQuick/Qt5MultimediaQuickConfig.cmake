...
set(Qt5MultimediaQuick_VERSION_STRING 5.15.8)
...
macro(_populate_MultimediaQuick_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5MultimediaQuick_install_prefix}/bin/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5MultimediaQuick_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_MultimediaQuick_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::MultimediaQuick)
    ...
    set(_Qt5MultimediaQuick_OWN_INCLUDE_DIRS "${_qt5MultimediaQuick_install_prefix}/include/qt/" "${_qt5MultimediaQuick_install_prefix}/include/qt/QtMultimediaQuick")
    set(Qt5MultimediaQuick_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaQuick_install_prefix}/include/qt/QtMultimediaQuick/5.15.8"
        "${_qt5MultimediaQuick_install_prefix}/include/qt/QtMultimediaQuick/5.15.8/QtMultimediaQuick"
    )
    ...
    set(_Qt5MultimediaQuick_MODULE_DEPENDENCIES "Quick;Multimedia;Core")
    ...
    foreach(_module_dep ${_Qt5MultimediaQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5MultimediaQuick_FIND_VERSION_EXACT}
    ...
    set(_Qt5MultimediaQuick_LIB_DEPENDENCIES "Qt5::Quick;Qt5::Multimedia;Qt5::Core")
    ...
    if (_Qt5MultimediaQuick_PRIVATE_DIRS_EXIST)
        ...
        if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::MultimediaQuickPrivate)
            add_library(Qt::MultimediaQuickPrivate INTERFACE IMPORTED)
            set_target_properties(Qt::MultimediaQuickPrivate PROPERTIES
                INTERFACE_LINK_LIBRARIES "Qt5::MultimediaQuickPrivate"
            )
        endif()
    endif()

    _populate_MultimediaQuick_target_properties(RELEASE "Qt5MultimediaQuick_conda.dll" "Qt5MultimediaQuick_conda.lib" FALSE)

    if (EXISTS
        "${_qt5MultimediaQuick_install_prefix}/bin/Qt5MultimediaQuick_condad.dll"
      AND EXISTS
        "${_qt5MultimediaQuick_install_prefix}/lib/Qt5MultimediaQuick_condad.lib" )
        _populate_MultimediaQuick_target_properties(DEBUG "Qt5MultimediaQuick_condad.dll" "Qt5MultimediaQuick_condad.lib" FALSE)
    endif()
...
# Add a versionless target, for compatibility with Qt6.
if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND TARGET Qt5::MultimediaQuick AND NOT TARGET Qt::MultimediaQuick)
    add_library(Qt::MultimediaQuick INTERFACE IMPORTED)
    set_target_properties(Qt::MultimediaQuick PROPERTIES
