...
if (NOT TARGET Qt5::Gui)
    ...
    set_property(TARGET Qt5::Gui PROPERTY INTERFACE_QT_DISABLED_FEATURES opengles2;combined-angle-lib;opengles3;opengles31;opengles32;openvg;system-textmarkdownreader;vulkan)

    # Qt 6 forward compatible properties.
    set_property(TARGET Qt5::Gui
                 PROPERTY QT_ENABLED_PUBLIC_FEATURES
                 accessibility;action;dynamicgl;angle;clipboard;colornames;cssparser;cursor;desktopservices;imageformat_xpm;draganddrop;opengl;imageformatplugin;highdpiscaling;im;image_heuristic_mask;image_text;imageformat_bmp;imageformat_jpeg;imageformat_png;imageformat_ppm;imageformat_xbm;movie;pdf;picture;sessionmanager;shortcut;standarditemmodel;systemtrayicon;tabletevent;texthtmlparser;textmarkdownreader;textmarkdownwriter;textodfwriter;validator;whatsthis;wheelevent)
    set_property(TARGET Qt5::Gui
                 PROPERTY QT_DISABLED_PUBLIC_FEATURES
                 opengles2;combined-angle-lib;opengles3;opengles31;opengles32;openvg;system-textmarkdownreader;vulkan)
    set_property(TARGET Qt5::Gui
                 PROPERTY QT_ENABLED_PRIVATE_FEATURES
                 dxguid;direct3d9;angle_d3d11_qdtd;dxgi;direct3d11;direct2d;direct2d1_1;dxgi1_2;direct3d11_1;directwrite;directwrite1;directwrite2;egl;freetype;gif;ico;imageio-text-loading;jpeg;multiprocess;png;raster-64bit;system-jpeg;system-png;tuiotouch;vkgen)
    set_property(TARGET Qt5::Gui
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 xcb;accessibility-atspi-bridge;directfb;drm_atomic;egl_x11;eglfs;eglfs_brcm;eglfs_egldevice;eglfs_gbm;eglfs_mali;eglfs_openwfd;eglfs_rcar;eglfs_viv;eglfs_viv_wl;eglfs_vsp2;eglfs_x11;evdev;fontconfig;harfbuzz;integrityfb;integrityhid;kms;libinput;libinput-axis-api;linuxfb;mtdev;system-freetype;system-harfbuzz;tslib;vnc;vsp2;xlib;xcb-xlib;xkbcommon;xkbcommon-x11)
    ...
    _populate_Gui_target_properties(RELEASE "Qt5Gui_conda.dll" "Qt5Gui_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Gui_install_prefix}/bin/Qt5Gui_condad.dll"
      AND EXISTS
        "${_qt5Gui_install_prefix}/lib/Qt5Gui_condad.lib" )
        _populate_Gui_target_properties(DEBUG "Qt5Gui_condad.dll" "Qt5Gui_condad.lib" FALSE)
    endif()
