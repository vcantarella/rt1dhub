...
set(Qt5UiTools_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::UiTools)
    ...
    set(Qt5UiTools_PRIVATE_INCLUDE_DIRS
        "${_qt5UiTools_install_prefix}/include/qt/QtUiTools/5.15.8"
        "${_qt5UiTools_install_prefix}/include/qt/QtUiTools/5.15.8/QtUiTools"
    )
    ...
    foreach(_module_dep ${_Qt5UiTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5UiTools_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_UiTools_process_prl_file(
            "${_qt5UiTools_install_prefix}/lib/Qt5UiTools_conda.prl" RELEASE
    ...
    if (_Qt5UiTools_PRIVATE_DIRS_EXIST)
        ...
        if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::UiToolsPrivate)
            add_library(Qt::UiToolsPrivate INTERFACE IMPORTED)
            set_target_properties(Qt::UiToolsPrivate PROPERTIES
                INTERFACE_LINK_LIBRARIES "Qt5::UiToolsPrivate"
            )
        endif()
    endif()

    _populate_UiTools_target_properties(RELEASE "Qt5UiTools_conda.lib" "" FALSE)

    if (EXISTS "${_qt5UiTools_install_prefix}/lib/Qt5UiTools_condad.lib" )
        _populate_UiTools_target_properties(DEBUG "Qt5UiTools_condad.lib" "" FALSE)
    endif()
    ...
    if (QT5_STRICT_PLUGIN_GLOB OR Qt5UiTools_STRICT_PLUGIN_GLOB)
        file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt5UiTools_*Plugin.cmake")
    else()
        file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt5UiTools_*.cmake")
    endif()
...
# Add a versionless target, for compatibility with Qt6.
if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND TARGET Qt5::UiTools AND NOT TARGET Qt::UiTools)
    add_library(Qt::UiTools INTERFACE IMPORTED)
    set_target_properties(Qt::UiTools PROPERTIES
        INTERFACE_LINK_LIBRARIES "Qt5::UiTools"
    )
endif()
