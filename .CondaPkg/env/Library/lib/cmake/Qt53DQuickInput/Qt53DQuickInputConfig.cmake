...
set(Qt53DQuickInput_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::3DQuickInput)
    ...
    set(_Qt53DQuickInput_OWN_INCLUDE_DIRS "${_qt53DQuickInput_install_prefix}/include/qt/" "${_qt53DQuickInput_install_prefix}/include/qt/Qt3DQuickInput")
    set(Qt53DQuickInput_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickInput_install_prefix}/include/qt/Qt3DQuickInput/5.15.8"
        "${_qt53DQuickInput_install_prefix}/include/qt/Qt3DQuickInput/5.15.8/Qt3DQuickInput"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickInput_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt53DQuickInput_FIND_VERSION_EXACT}
    ...
    _populate_3DQuickInput_target_properties(RELEASE "Qt53DQuickInput_conda.dll" "Qt53DQuickInput_conda.lib" FALSE)

    if (EXISTS
        "${_qt53DQuickInput_install_prefix}/bin/Qt53DQuickInput_condad.dll"
      AND EXISTS
        "${_qt53DQuickInput_install_prefix}/lib/Qt53DQuickInput_condad.lib" )
        _populate_3DQuickInput_target_properties(DEBUG "Qt53DQuickInput_condad.dll" "Qt53DQuickInput_condad.lib" FALSE)
    endif()
