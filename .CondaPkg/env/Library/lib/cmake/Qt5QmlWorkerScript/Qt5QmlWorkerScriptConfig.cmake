...
set(Qt5QmlWorkerScript_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::QmlWorkerScript)
    ...
    set(_Qt5QmlWorkerScript_OWN_INCLUDE_DIRS "${_qt5QmlWorkerScript_install_prefix}/include/qt/" "${_qt5QmlWorkerScript_install_prefix}/include/qt/QtQmlWorkerScript")
    set(Qt5QmlWorkerScript_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlWorkerScript_install_prefix}/include/qt/QtQmlWorkerScript/5.15.8"
        "${_qt5QmlWorkerScript_install_prefix}/include/qt/QtQmlWorkerScript/5.15.8/QtQmlWorkerScript"
    )
    ...
    foreach(_module_dep ${_Qt5QmlWorkerScript_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5QmlWorkerScript_FIND_VERSION_EXACT}
    ...
    _populate_QmlWorkerScript_target_properties(RELEASE "Qt5QmlWorkerScript_conda.dll" "Qt5QmlWorkerScript_conda.lib" FALSE)

    if (EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/bin/Qt5QmlWorkerScript_condad.dll"
      AND EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/lib/Qt5QmlWorkerScript_condad.lib" )
        _populate_QmlWorkerScript_target_properties(DEBUG "Qt5QmlWorkerScript_condad.dll" "Qt5QmlWorkerScript_condad.lib" FALSE)
    endif()
