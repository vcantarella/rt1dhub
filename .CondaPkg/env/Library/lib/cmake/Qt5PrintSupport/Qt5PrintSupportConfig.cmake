...
set(Qt5PrintSupport_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::PrintSupport)
    ...
    set(_Qt5PrintSupport_OWN_INCLUDE_DIRS "${_qt5PrintSupport_install_prefix}/include/qt/" "${_qt5PrintSupport_install_prefix}/include/qt/QtPrintSupport")
    set(Qt5PrintSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PrintSupport_install_prefix}/include/qt/QtPrintSupport/5.15.8"
        "${_qt5PrintSupport_install_prefix}/include/qt/QtPrintSupport/5.15.8/QtPrintSupport"
    )
    ...
    foreach(_module_dep ${_Qt5PrintSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5PrintSupport_FIND_VERSION_EXACT}
    ...
    _populate_PrintSupport_target_properties(RELEASE "Qt5PrintSupport_conda.dll" "Qt5PrintSupport_conda.lib" FALSE)

    if (EXISTS
        "${_qt5PrintSupport_install_prefix}/bin/Qt5PrintSupport_condad.dll"
      AND EXISTS
        "${_qt5PrintSupport_install_prefix}/lib/Qt5PrintSupport_condad.lib" )
        _populate_PrintSupport_target_properties(DEBUG "Qt5PrintSupport_condad.dll" "Qt5PrintSupport_condad.lib" FALSE)
    endif()
