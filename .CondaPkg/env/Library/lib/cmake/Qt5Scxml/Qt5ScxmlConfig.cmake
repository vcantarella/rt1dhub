...
if (NOT TARGET Qt5::Scxml)
    ...
    _populate_Scxml_target_properties(RELEASE "Qt5Scxml_conda.dll" "Qt5Scxml_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Scxml_install_prefix}/bin/Qt5Scxml_condad.dll"
      AND EXISTS
        "${_qt5Scxml_install_prefix}/lib/Qt5Scxml_condad.lib" )
        _populate_Scxml_target_properties(DEBUG "Qt5Scxml_condad.dll" "Qt5Scxml_condad.lib" FALSE)
    endif()
