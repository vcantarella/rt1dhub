...
if (NOT TARGET Qt5::MultimediaWidgets)
    ...
    _populate_MultimediaWidgets_target_properties(RELEASE "Qt5MultimediaWidgets_conda.dll" "Qt5MultimediaWidgets_conda.lib" FALSE)

    if (EXISTS
        "${_qt5MultimediaWidgets_install_prefix}/bin/Qt5MultimediaWidgets_condad.dll"
      AND EXISTS
        "${_qt5MultimediaWidgets_install_prefix}/lib/Qt5MultimediaWidgets_condad.lib" )
        _populate_MultimediaWidgets_target_properties(DEBUG "Qt5MultimediaWidgets_condad.dll" "Qt5MultimediaWidgets_condad.lib" FALSE)
    endif()
