...
set(Qt5Script_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::Script)
    ...
    set(_Qt5Script_OWN_INCLUDE_DIRS "${_qt5Script_install_prefix}/include/qt/" "${_qt5Script_install_prefix}/include/qt/QtScript")
    set(Qt5Script_PRIVATE_INCLUDE_DIRS
        "${_qt5Script_install_prefix}/include/qt/QtScript/5.15.8"
        "${_qt5Script_install_prefix}/include/qt/QtScript/5.15.8/QtScript"
    )
    ...
    foreach(_module_dep ${_Qt5Script_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5Script_FIND_VERSION_EXACT}
    ...
    _populate_Script_target_properties(RELEASE "Qt5Script_conda.dll" "Qt5Script_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Script_install_prefix}/bin/Qt5Script_condad.dll"
      AND EXISTS
        "${_qt5Script_install_prefix}/lib/Qt5Script_condad.lib" )
        _populate_Script_target_properties(DEBUG "Qt5Script_condad.dll" "Qt5Script_condad.lib" FALSE)
    endif()
