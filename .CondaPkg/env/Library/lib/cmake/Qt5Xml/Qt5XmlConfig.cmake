...
if (NOT TARGET Qt5::Xml)
    ...
    _populate_Xml_target_properties(RELEASE "Qt5Xml_conda.dll" "Qt5Xml_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Xml_install_prefix}/bin/Qt5Xml_condad.dll"
      AND EXISTS
        "${_qt5Xml_install_prefix}/lib/Qt5Xml_condad.lib" )
        _populate_Xml_target_properties(DEBUG "Qt5Xml_condad.dll" "Qt5Xml_condad.lib" FALSE)
    endif()
