...
if (NOT TARGET Qt5::3DRender)
    ...
    _populate_3DRender_target_properties(RELEASE "Qt53DRender_conda.dll" "Qt53DRender_conda.lib" FALSE)

    if (EXISTS
        "${_qt53DRender_install_prefix}/bin/Qt53DRender_condad.dll"
      AND EXISTS
        "${_qt53DRender_install_prefix}/lib/Qt53DRender_condad.lib" )
        _populate_3DRender_target_properties(DEBUG "Qt53DRender_condad.dll" "Qt53DRender_condad.lib" FALSE)
    endif()
