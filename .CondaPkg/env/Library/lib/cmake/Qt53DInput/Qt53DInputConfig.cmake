...
set(Qt53DInput_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::3DInput)
    ...
    set(Qt53DInput_PRIVATE_INCLUDE_DIRS
        "${_qt53DInput_install_prefix}/include/qt/Qt3DInput/5.15.8"
        "${_qt53DInput_install_prefix}/include/qt/Qt3DInput/5.15.8/Qt3DInput"
    )
    ...
    foreach(_module_dep ${_Qt53DInput_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt53DInput_FIND_VERSION_EXACT}
    ...
    _populate_3DInput_target_properties(RELEASE "Qt53DInput_conda.dll" "Qt53DInput_conda.lib" FALSE)

    if (EXISTS
        "${_qt53DInput_install_prefix}/bin/Qt53DInput_condad.dll"
      AND EXISTS
        "${_qt53DInput_install_prefix}/lib/Qt53DInput_condad.lib" )
        _populate_3DInput_target_properties(DEBUG "Qt53DInput_condad.dll" "Qt53DInput_condad.lib" FALSE)
    endif()
