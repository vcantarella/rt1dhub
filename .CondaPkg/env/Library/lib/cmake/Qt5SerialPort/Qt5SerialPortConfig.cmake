...
if (NOT TARGET Qt5::SerialPort)
    ...
    _populate_SerialPort_target_properties(RELEASE "Qt5SerialPort_conda.dll" "Qt5SerialPort_conda.lib" FALSE)

    if (EXISTS
        "${_qt5SerialPort_install_prefix}/bin/Qt5SerialPort_condad.dll"
      AND EXISTS
        "${_qt5SerialPort_install_prefix}/lib/Qt5SerialPort_condad.lib" )
        _populate_SerialPort_target_properties(DEBUG "Qt5SerialPort_condad.dll" "Qt5SerialPort_condad.lib" FALSE)
    endif()
