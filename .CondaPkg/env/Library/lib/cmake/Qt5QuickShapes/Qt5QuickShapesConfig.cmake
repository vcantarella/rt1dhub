...
if (NOT TARGET Qt5::QuickShapes)
    ...
    _populate_QuickShapes_target_properties(RELEASE "Qt5QuickShapes_conda.dll" "Qt5QuickShapes_conda.lib" FALSE)

    if (EXISTS
        "${_qt5QuickShapes_install_prefix}/bin/Qt5QuickShapes_condad.dll"
      AND EXISTS
        "${_qt5QuickShapes_install_prefix}/lib/Qt5QuickShapes_condad.lib" )
        _populate_QuickShapes_target_properties(DEBUG "Qt5QuickShapes_condad.dll" "Qt5QuickShapes_condad.lib" FALSE)
    endif()
