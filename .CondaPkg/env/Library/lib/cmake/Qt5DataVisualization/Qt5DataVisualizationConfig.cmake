...
set(Qt5DataVisualization_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::DataVisualization)
    ...
    set(_Qt5DataVisualization_OWN_INCLUDE_DIRS "${_qt5DataVisualization_install_prefix}/include/qt/" "${_qt5DataVisualization_install_prefix}/include/qt/QtDataVisualization")
    set(Qt5DataVisualization_PRIVATE_INCLUDE_DIRS
        "${_qt5DataVisualization_install_prefix}/include/qt/QtDataVisualization/5.15.8"
        "${_qt5DataVisualization_install_prefix}/include/qt/QtDataVisualization/5.15.8/QtDataVisualization"
    )
    ...
    foreach(_module_dep ${_Qt5DataVisualization_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5DataVisualization_FIND_VERSION_EXACT}
    ...
    _populate_DataVisualization_target_properties(RELEASE "Qt5DataVisualization_conda.dll" "Qt5DataVisualization_conda.lib" FALSE)

    if (EXISTS
        "${_qt5DataVisualization_install_prefix}/bin/Qt5DataVisualization_condad.dll"
      AND EXISTS
        "${_qt5DataVisualization_install_prefix}/lib/Qt5DataVisualization_condad.lib" )
        _populate_DataVisualization_target_properties(DEBUG "Qt5DataVisualization_condad.dll" "Qt5DataVisualization_condad.lib" FALSE)
    endif()
