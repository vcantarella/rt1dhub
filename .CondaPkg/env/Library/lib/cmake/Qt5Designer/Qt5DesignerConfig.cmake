...
if (NOT TARGET Qt5::Designer)
    ...
    _populate_Designer_target_properties(RELEASE "Qt5Designer_conda.dll" "Qt5Designer_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Designer_install_prefix}/bin/Qt5Designer_condad.dll"
      AND EXISTS
        "${_qt5Designer_install_prefix}/lib/Qt5Designer_condad.lib" )
        _populate_Designer_target_properties(DEBUG "Qt5Designer_condad.dll" "Qt5Designer_condad.lib" FALSE)
    endif()
