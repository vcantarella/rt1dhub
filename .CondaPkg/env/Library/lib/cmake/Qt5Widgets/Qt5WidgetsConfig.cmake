...
if (NOT TARGET Qt5::Widgets)
    ...
    set_property(TARGET Qt5::Widgets
                 ...
                 widgettextcontrol;effects;style-fusion;style-windows;style-windowsvista)
    set_property(TARGET Qt5::Widgets
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 gtk3;style-android;style-mac)
    ...
    _populate_Widgets_target_properties(RELEASE "Qt5Widgets_conda.dll" "Qt5Widgets_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Widgets_install_prefix}/bin/Qt5Widgets_condad.dll"
      AND EXISTS
        "${_qt5Widgets_install_prefix}/lib/Qt5Widgets_condad.lib" )
        _populate_Widgets_target_properties(DEBUG "Qt5Widgets_condad.dll" "Qt5Widgets_condad.lib" FALSE)
    endif()
