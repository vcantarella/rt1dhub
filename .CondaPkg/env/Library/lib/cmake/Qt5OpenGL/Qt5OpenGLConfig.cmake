...
if (NOT TARGET Qt5::OpenGL)
    ...
    _populate_OpenGL_target_properties(RELEASE "Qt5OpenGL_conda.dll" "Qt5OpenGL_conda.lib" FALSE)

    if (EXISTS
        "${_qt5OpenGL_install_prefix}/bin/Qt5OpenGL_condad.dll"
      AND EXISTS
        "${_qt5OpenGL_install_prefix}/lib/Qt5OpenGL_condad.lib" )
        _populate_OpenGL_target_properties(DEBUG "Qt5OpenGL_condad.dll" "Qt5OpenGL_condad.lib" FALSE)
    endif()
