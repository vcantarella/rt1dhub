...
if (NOT TARGET Qt5::WebView)
    ...
    _populate_WebView_target_properties(RELEASE "Qt5WebView_conda.dll" "Qt5WebView_conda.lib" FALSE)

    if (EXISTS
        "${_qt5WebView_install_prefix}/bin/Qt5WebView_condad.dll"
      AND EXISTS
        "${_qt5WebView_install_prefix}/lib/Qt5WebView_condad.lib" )
        _populate_WebView_target_properties(DEBUG "Qt5WebView_condad.dll" "Qt5WebView_condad.lib" FALSE)
    endif()
