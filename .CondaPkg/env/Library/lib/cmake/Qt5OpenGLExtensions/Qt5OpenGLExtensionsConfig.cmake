...
set(Qt5OpenGLExtensions_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::OpenGLExtensions)
    ...
    set(_Qt5OpenGLExtensions_OWN_INCLUDE_DIRS "${_qt5OpenGLExtensions_install_prefix}/include/qt/" "${_qt5OpenGLExtensions_install_prefix}/include/qt/QtOpenGLExtensions")
    ...
    foreach(_module_dep ${_Qt5OpenGLExtensions_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5OpenGLExtensions_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_OpenGLExtensions_process_prl_file(
            "${_qt5OpenGLExtensions_install_prefix}/lib/Qt5OpenGLExtensions_conda.prl" RELEASE
    ...
    _populate_OpenGLExtensions_target_properties(RELEASE "Qt5OpenGLExtensions_conda.lib" "" FALSE)

    if (EXISTS "${_qt5OpenGLExtensions_install_prefix}/lib/Qt5OpenGLExtensions_condad.lib" )
        _populate_OpenGLExtensions_target_properties(DEBUG "Qt5OpenGLExtensions_condad.lib" "" FALSE)
    endif()
