...
set(Qt53DQuick_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::3DQuick)
    ...
    set(Qt53DQuick_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuick_install_prefix}/include/qt/Qt3DQuick/5.15.8"
        "${_qt53DQuick_install_prefix}/include/qt/Qt3DQuick/5.15.8/Qt3DQuick"
    )
    ...
    foreach(_module_dep ${_Qt53DQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt53DQuick_FIND_VERSION_EXACT}
    ...
    _populate_3DQuick_target_properties(RELEASE "Qt53DQuick_conda.dll" "Qt53DQuick_conda.lib" FALSE)

    if (EXISTS
        "${_qt53DQuick_install_prefix}/bin/Qt53DQuick_condad.dll"
      AND EXISTS
        "${_qt53DQuick_install_prefix}/lib/Qt53DQuick_condad.lib" )
        _populate_3DQuick_target_properties(DEBUG "Qt53DQuick_condad.dll" "Qt53DQuick_condad.lib" FALSE)
    endif()
