...
set(Qt5ThemeSupport_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::ThemeSupport)
    ...
    set(_Qt5ThemeSupport_OWN_INCLUDE_DIRS "${_qt5ThemeSupport_install_prefix}/include/qt/" "${_qt5ThemeSupport_install_prefix}/include/qt/QtThemeSupport")
    set(Qt5ThemeSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5ThemeSupport_install_prefix}/include/qt/QtThemeSupport/5.15.8"
        "${_qt5ThemeSupport_install_prefix}/include/qt/QtThemeSupport/5.15.8/QtThemeSupport"
    )
    ...
    foreach(_module_dep ${_Qt5ThemeSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5ThemeSupport_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_ThemeSupport_process_prl_file(
            "${_qt5ThemeSupport_install_prefix}/lib/Qt5ThemeSupport_conda.prl" RELEASE
    ...
    _populate_ThemeSupport_target_properties(RELEASE "Qt5ThemeSupport_conda.lib" "" FALSE)

    if (EXISTS "${_qt5ThemeSupport_install_prefix}/lib/Qt5ThemeSupport_condad.lib" )
        _populate_ThemeSupport_target_properties(DEBUG "Qt5ThemeSupport_condad.lib" "" FALSE)
    endif()
