...
if (NOT TARGET Qt5::Svg)
    ...
    _populate_Svg_target_properties(RELEASE "Qt5Svg_conda.dll" "Qt5Svg_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Svg_install_prefix}/bin/Qt5Svg_condad.dll"
      AND EXISTS
        "${_qt5Svg_install_prefix}/lib/Qt5Svg_condad.lib" )
        _populate_Svg_target_properties(DEBUG "Qt5Svg_condad.dll" "Qt5Svg_condad.lib" FALSE)
    endif()
