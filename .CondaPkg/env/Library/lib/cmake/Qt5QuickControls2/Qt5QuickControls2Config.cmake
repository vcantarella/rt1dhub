...
set(Qt5QuickControls2_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::QuickControls2)
    ...
    set(_Qt5QuickControls2_OWN_INCLUDE_DIRS "${_qt5QuickControls2_install_prefix}/include/qt/" "${_qt5QuickControls2_install_prefix}/include/qt/QtQuickControls2")
    set(Qt5QuickControls2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickControls2_install_prefix}/include/qt/QtQuickControls2/5.15.8"
        "${_qt5QuickControls2_install_prefix}/include/qt/QtQuickControls2/5.15.8/QtQuickControls2"
    )
    ...
    foreach(_module_dep ${_Qt5QuickControls2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5QuickControls2_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::QuickControls2
                 ...
                 quickcontrols2-default;quickcontrols2-fusion;quickcontrols2-imagine;quickcontrols2-material;quickcontrols2-universal)
    set_property(TARGET Qt5::QuickControls2
    ...
    if (_Qt5QuickControls2_PRIVATE_DIRS_EXIST)
        ...
        if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::QuickControls2Private)
            add_library(Qt::QuickControls2Private INTERFACE IMPORTED)
            set_target_properties(Qt::QuickControls2Private PROPERTIES
                INTERFACE_LINK_LIBRARIES "Qt5::QuickControls2Private"
            )
        endif()
    endif()

    _populate_QuickControls2_target_properties(RELEASE "Qt5QuickControls2_conda.dll" "Qt5QuickControls2_conda.lib" FALSE)

    if (EXISTS
        "${_qt5QuickControls2_install_prefix}/bin/Qt5QuickControls2_condad.dll"
      AND EXISTS
        "${_qt5QuickControls2_install_prefix}/lib/Qt5QuickControls2_condad.lib" )
        _populate_QuickControls2_target_properties(DEBUG "Qt5QuickControls2_condad.dll" "Qt5QuickControls2_condad.lib" FALSE)
    endif()
    ...
    if (QT5_STRICT_PLUGIN_GLOB OR Qt5QuickControls2_STRICT_PLUGIN_GLOB)
        file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt5QuickControls2_*Plugin.cmake")
    else()
        file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt5QuickControls2_*.cmake")
    endif()
...
# Add a versionless target, for compatibility with Qt6.
if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND TARGET Qt5::QuickControls2 AND NOT TARGET Qt::QuickControls2)
    add_library(Qt::QuickControls2 INTERFACE IMPORTED)
    set_target_properties(Qt::QuickControls2 PROPERTIES
