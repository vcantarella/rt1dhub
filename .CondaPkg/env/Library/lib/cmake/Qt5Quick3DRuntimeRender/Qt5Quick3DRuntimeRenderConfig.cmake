...
set(Qt5Quick3DRuntimeRender_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::Quick3DRuntimeRender)
    ...
    set(_Qt5Quick3DRuntimeRender_OWN_INCLUDE_DIRS "${_qt5Quick3DRuntimeRender_install_prefix}/include/qt/" "${_qt5Quick3DRuntimeRender_install_prefix}/include/qt/QtQuick3DRuntimeRender")
    set(Qt5Quick3DRuntimeRender_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick3DRuntimeRender_install_prefix}/include/qt/QtQuick3DRuntimeRender/5.15.8"
        "${_qt5Quick3DRuntimeRender_install_prefix}/include/qt/QtQuick3DRuntimeRender/5.15.8/QtQuick3DRuntimeRender"
    )
    ...
    foreach(_module_dep ${_Qt5Quick3DRuntimeRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5Quick3DRuntimeRender_FIND_VERSION_EXACT}
    ...
    _populate_Quick3DRuntimeRender_target_properties(RELEASE "Qt5Quick3DRuntimeRender_conda.dll" "Qt5Quick3DRuntimeRender_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Quick3DRuntimeRender_install_prefix}/bin/Qt5Quick3DRuntimeRender_condad.dll"
      AND EXISTS
        "${_qt5Quick3DRuntimeRender_install_prefix}/lib/Qt5Quick3DRuntimeRender_condad.lib" )
        _populate_Quick3DRuntimeRender_target_properties(DEBUG "Qt5Quick3DRuntimeRender_condad.dll" "Qt5Quick3DRuntimeRender_condad.lib" FALSE)
    endif()
