...
if (NOT TARGET Qt5::Qml)
    ...
    _populate_Qml_target_properties(RELEASE "Qt5Qml_conda.dll" "Qt5Qml_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Qml_install_prefix}/bin/Qt5Qml_condad.dll"
      AND EXISTS
        "${_qt5Qml_install_prefix}/lib/Qt5Qml_condad.lib" )
        _populate_Qml_target_properties(DEBUG "Qt5Qml_condad.dll" "Qt5Qml_condad.lib" FALSE)
    endif()
