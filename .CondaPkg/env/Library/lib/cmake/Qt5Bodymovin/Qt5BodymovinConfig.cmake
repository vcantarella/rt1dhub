...
macro(_populate_Bodymovin_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Bodymovin_install_prefix}/bin/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5Bodymovin_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_Bodymovin_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::Bodymovin)
    ...
    _populate_Bodymovin_target_properties(RELEASE "Qt5Bodymovin_conda.dll" "Qt5Bodymovin_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Bodymovin_install_prefix}/bin/Qt5Bodymovin_condad.dll"
      AND EXISTS
        "${_qt5Bodymovin_install_prefix}/lib/Qt5Bodymovin_condad.lib" )
        _populate_Bodymovin_target_properties(DEBUG "Qt5Bodymovin_condad.dll" "Qt5Bodymovin_condad.lib" FALSE)
    endif()
