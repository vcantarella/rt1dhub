...
if (NOT TARGET Qt5::Sensors)
    ...
    _populate_Sensors_target_properties(RELEASE "Qt5Sensors_conda.dll" "Qt5Sensors_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Sensors_install_prefix}/bin/Qt5Sensors_condad.dll"
      AND EXISTS
        "${_qt5Sensors_install_prefix}/lib/Qt5Sensors_condad.lib" )
        _populate_Sensors_target_properties(DEBUG "Qt5Sensors_condad.dll" "Qt5Sensors_condad.lib" FALSE)
    endif()
