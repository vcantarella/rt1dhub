...
if (NOT TARGET Qt5::Bluetooth)
    ...
    set_property(TARGET Qt5::Bluetooth
                 ...
                 winrt_bt;winrt_btle_no_pairing)
    set_property(TARGET Qt5::Bluetooth
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 bluez_le;linux_crypto_api)
    ...
    _populate_Bluetooth_target_properties(RELEASE "Qt5Bluetooth_conda.dll" "Qt5Bluetooth_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Bluetooth_install_prefix}/bin/Qt5Bluetooth_condad.dll"
      AND EXISTS
        "${_qt5Bluetooth_install_prefix}/lib/Qt5Bluetooth_condad.lib" )
        _populate_Bluetooth_target_properties(DEBUG "Qt5Bluetooth_condad.dll" "Qt5Bluetooth_condad.lib" FALSE)
    endif()
