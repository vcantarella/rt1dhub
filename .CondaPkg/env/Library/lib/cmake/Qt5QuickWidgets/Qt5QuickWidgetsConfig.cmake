...
set(Qt5QuickWidgets_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::QuickWidgets)
    ...
    set(_Qt5QuickWidgets_OWN_INCLUDE_DIRS "${_qt5QuickWidgets_install_prefix}/include/qt/" "${_qt5QuickWidgets_install_prefix}/include/qt/QtQuickWidgets")
    set(Qt5QuickWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickWidgets_install_prefix}/include/qt/QtQuickWidgets/5.15.8"
        "${_qt5QuickWidgets_install_prefix}/include/qt/QtQuickWidgets/5.15.8/QtQuickWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5QuickWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5QuickWidgets_FIND_VERSION_EXACT}
    ...
    _populate_QuickWidgets_target_properties(RELEASE "Qt5QuickWidgets_conda.dll" "Qt5QuickWidgets_conda.lib" FALSE)

    if (EXISTS
        "${_qt5QuickWidgets_install_prefix}/bin/Qt5QuickWidgets_condad.dll"
      AND EXISTS
        "${_qt5QuickWidgets_install_prefix}/lib/Qt5QuickWidgets_condad.lib" )
        _populate_QuickWidgets_target_properties(DEBUG "Qt5QuickWidgets_condad.dll" "Qt5QuickWidgets_condad.lib" FALSE)
    endif()
