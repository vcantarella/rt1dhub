...
if (NOT TARGET Qt5::Positioning)
    ...
    _populate_Positioning_target_properties(RELEASE "Qt5Positioning_conda.dll" "Qt5Positioning_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Positioning_install_prefix}/bin/Qt5Positioning_condad.dll"
      AND EXISTS
        "${_qt5Positioning_install_prefix}/lib/Qt5Positioning_condad.lib" )
        _populate_Positioning_target_properties(DEBUG "Qt5Positioning_condad.dll" "Qt5Positioning_condad.lib" FALSE)
    endif()
