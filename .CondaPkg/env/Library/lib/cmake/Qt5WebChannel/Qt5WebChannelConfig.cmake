...
set(Qt5WebChannel_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::WebChannel)
    ...
    set(Qt5WebChannel_PRIVATE_INCLUDE_DIRS
        "${_qt5WebChannel_install_prefix}/include/qt/QtWebChannel/5.15.8"
        "${_qt5WebChannel_install_prefix}/include/qt/QtWebChannel/5.15.8/QtWebChannel"
    )
    ...
    foreach(_module_dep ${_Qt5WebChannel_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5WebChannel_FIND_VERSION_EXACT}
    ...
    _populate_WebChannel_target_properties(RELEASE "Qt5WebChannel_conda.dll" "Qt5WebChannel_conda.lib" FALSE)

    if (EXISTS
        "${_qt5WebChannel_install_prefix}/bin/Qt5WebChannel_condad.dll"
      AND EXISTS
        "${_qt5WebChannel_install_prefix}/lib/Qt5WebChannel_condad.lib" )
        _populate_WebChannel_target_properties(DEBUG "Qt5WebChannel_condad.dll" "Qt5WebChannel_condad.lib" FALSE)
    endif()
