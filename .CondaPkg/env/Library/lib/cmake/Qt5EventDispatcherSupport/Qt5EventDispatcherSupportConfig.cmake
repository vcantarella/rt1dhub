...
set(Qt5EventDispatcherSupport_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::EventDispatcherSupport)
    ...
    set(_Qt5EventDispatcherSupport_OWN_INCLUDE_DIRS "${_qt5EventDispatcherSupport_install_prefix}/include/qt/" "${_qt5EventDispatcherSupport_install_prefix}/include/qt/QtEventDispatcherSupport")
    set(Qt5EventDispatcherSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5EventDispatcherSupport_install_prefix}/include/qt/QtEventDispatcherSupport/5.15.8"
        "${_qt5EventDispatcherSupport_install_prefix}/include/qt/QtEventDispatcherSupport/5.15.8/QtEventDispatcherSupport"
    )
    ...
    foreach(_module_dep ${_Qt5EventDispatcherSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5EventDispatcherSupport_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_EventDispatcherSupport_process_prl_file(
            "${_qt5EventDispatcherSupport_install_prefix}/lib/Qt5EventDispatcherSupport_conda.prl" RELEASE
    ...
    _populate_EventDispatcherSupport_target_properties(RELEASE "Qt5EventDispatcherSupport_conda.lib" "" FALSE)

    if (EXISTS "${_qt5EventDispatcherSupport_install_prefix}/lib/Qt5EventDispatcherSupport_condad.lib" )
        _populate_EventDispatcherSupport_target_properties(DEBUG "Qt5EventDispatcherSupport_condad.lib" "" FALSE)
    endif()
