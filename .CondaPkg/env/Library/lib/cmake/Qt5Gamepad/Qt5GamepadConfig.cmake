...
if (NOT TARGET Qt5::Gamepad)
    ...
    _populate_Gamepad_target_properties(RELEASE "Qt5Gamepad_conda.dll" "Qt5Gamepad_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Gamepad_install_prefix}/bin/Qt5Gamepad_condad.dll"
      AND EXISTS
        "${_qt5Gamepad_install_prefix}/lib/Qt5Gamepad_condad.lib" )
        _populate_Gamepad_target_properties(DEBUG "Qt5Gamepad_condad.dll" "Qt5Gamepad_condad.lib" FALSE)
    endif()
