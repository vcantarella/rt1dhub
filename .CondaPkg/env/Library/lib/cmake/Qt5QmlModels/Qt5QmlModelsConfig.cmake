...
if (NOT TARGET Qt5::QmlModels)
    ...
    _populate_QmlModels_target_properties(RELEASE "Qt5QmlModels_conda.dll" "Qt5QmlModels_conda.lib" FALSE)

    if (EXISTS
        "${_qt5QmlModels_install_prefix}/bin/Qt5QmlModels_condad.dll"
      AND EXISTS
        "${_qt5QmlModels_install_prefix}/lib/Qt5QmlModels_condad.lib" )
        _populate_QmlModels_target_properties(DEBUG "Qt5QmlModels_condad.dll" "Qt5QmlModels_condad.lib" FALSE)
    endif()
