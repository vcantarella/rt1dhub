...
set(Qt5QmlDevTools_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::QmlDevTools)
    ...
    set(_Qt5QmlDevTools_OWN_INCLUDE_DIRS "${_qt5QmlDevTools_install_prefix}/include/qt/" "${_qt5QmlDevTools_install_prefix}/include/qt/QtQml")
    set(Qt5QmlDevTools_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlDevTools_install_prefix}/include/qt/QtQml/5.15.8"
        "${_qt5QmlDevTools_install_prefix}/include/qt/QtQml/5.15.8/QtQml"
    )
    ...
    foreach(_module_dep ${_Qt5QmlDevTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5QmlDevTools_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_QmlDevTools_process_prl_file(
            "${_qt5QmlDevTools_install_prefix}/lib/Qt5QmlDevTools_conda.prl" RELEASE
    ...
    set_property(TARGET Qt5::QmlDevTools
    ...
    if (_Qt5QmlDevTools_PRIVATE_DIRS_EXIST)
        ...
        if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::QmlDevToolsPrivate)
            add_library(Qt::QmlDevToolsPrivate INTERFACE IMPORTED)
            set_target_properties(Qt::QmlDevToolsPrivate PROPERTIES
                INTERFACE_LINK_LIBRARIES "Qt5::QmlDevToolsPrivate"
            )
        endif()
    endif()

    _populate_QmlDevTools_target_properties(RELEASE "Qt5QmlDevTools_conda.lib" "" FALSE)

    if (EXISTS "${_qt5QmlDevTools_install_prefix}/lib/Qt5QmlDevTools_condad.lib" )
        _populate_QmlDevTools_target_properties(DEBUG "Qt5QmlDevTools_condad.lib" "" FALSE)
    endif()
...
# Add a versionless target, for compatibility with Qt6.
if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND TARGET Qt5::QmlDevTools AND NOT TARGET Qt::QmlDevTools)
    add_library(Qt::QmlDevTools INTERFACE IMPORTED)
    set_target_properties(Qt::QmlDevTools PROPERTIES
        INTERFACE_LINK_LIBRARIES "Qt5::QmlDevTools"
    )
endif()
