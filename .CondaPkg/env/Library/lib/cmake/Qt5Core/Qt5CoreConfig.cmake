...
if (NOT TARGET Qt5::Core)
    ...
    set_property(TARGET Qt5::Core
                 ...
                 datetimeparser;doubleconversion;hijricalendar;icu;mimetype-database;system-pcre2;sha3-fast)
    set_property(TARGET Qt5::Core
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 clock-gettime;etw;futimens;futimes;getauxval;getentropy;glib;glibc;gnu-libiconv;iconv;inotify;journald;linkat;lttng;posix-libiconv;renameat2;slog2;statx;syslog;system-doubleconversion)
    ...
    _populate_Core_target_properties(RELEASE "Qt5Core_conda.dll" "Qt5Core_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Core_install_prefix}/bin/Qt5Core_condad.dll"
      AND EXISTS
        "${_qt5Core_install_prefix}/lib/Qt5Core_condad.lib" )
        _populate_Core_target_properties(DEBUG "Qt5Core_condad.dll" "Qt5Core_condad.lib" FALSE)
    endif()
