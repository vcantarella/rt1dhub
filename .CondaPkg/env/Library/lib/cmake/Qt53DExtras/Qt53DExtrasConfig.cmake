...
set(Qt53DExtras_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::3DExtras)
    ...
    set(_Qt53DExtras_OWN_INCLUDE_DIRS "${_qt53DExtras_install_prefix}/include/qt/" "${_qt53DExtras_install_prefix}/include/qt/Qt3DExtras")
    set(Qt53DExtras_PRIVATE_INCLUDE_DIRS
        "${_qt53DExtras_install_prefix}/include/qt/Qt3DExtras/5.15.8"
        "${_qt53DExtras_install_prefix}/include/qt/Qt3DExtras/5.15.8/Qt3DExtras"
    )
    ...
    foreach(_module_dep ${_Qt53DExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt53DExtras_FIND_VERSION_EXACT}
    ...
    _populate_3DExtras_target_properties(RELEASE "Qt53DExtras_conda.dll" "Qt53DExtras_conda.lib" FALSE)

    if (EXISTS
        "${_qt53DExtras_install_prefix}/bin/Qt53DExtras_condad.dll"
      AND EXISTS
        "${_qt53DExtras_install_prefix}/lib/Qt53DExtras_condad.lib" )
        _populate_3DExtras_target_properties(DEBUG "Qt53DExtras_condad.dll" "Qt53DExtras_condad.lib" FALSE)
    endif()
