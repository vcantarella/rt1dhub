...
set(Qt5Concurrent_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::Concurrent)
    ...
    set(_Qt5Concurrent_OWN_INCLUDE_DIRS "${_qt5Concurrent_install_prefix}/include/qt/" "${_qt5Concurrent_install_prefix}/include/qt/QtConcurrent")
    ...
    foreach(_module_dep ${_Qt5Concurrent_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5Concurrent_FIND_VERSION_EXACT}
    ...
    _populate_Concurrent_target_properties(RELEASE "Qt5Concurrent_conda.dll" "Qt5Concurrent_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Concurrent_install_prefix}/bin/Qt5Concurrent_condad.dll"
      AND EXISTS
        "${_qt5Concurrent_install_prefix}/lib/Qt5Concurrent_condad.lib" )
        _populate_Concurrent_target_properties(DEBUG "Qt5Concurrent_condad.dll" "Qt5Concurrent_condad.lib" FALSE)
    endif()
